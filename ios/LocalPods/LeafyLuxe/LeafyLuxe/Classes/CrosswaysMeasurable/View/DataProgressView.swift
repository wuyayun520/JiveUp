...
fileprivate let str_paraValue:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class DataProgressView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_paraValue.reversed(), encoding: .utf8)!)
    }
    ...
    init(frame: CGRect, progressBgColor: UIColor, progressPlayedColor: UIColor, progressCachedColor: UIColor) {
        ...
        self.swaddlingClothesCurrentSubEqual()
...
extension DataProgressView {
    // 添加视图
    //: private func setupSubviews() {
    private func dominoRead() {
    ...
    private func swaddlingClothesCurrentSubEqual() {
