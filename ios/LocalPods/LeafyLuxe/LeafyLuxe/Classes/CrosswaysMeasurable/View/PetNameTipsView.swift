...
fileprivate let str_visibleRestoreName:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "Tips" :*/
fileprivate let str_leadingData:[Character] = ["T","i","p","s"]
...
fileprivate let str_imageRequestData:[UInt8] = []

private func thinkOfRemove(awake num: UInt8) -> UInt8 {
    return num ^ 186
}

/*: "#777777" :*/
fileprivate let str_tapName:String = "#777777"
...
class PetNameTipsView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_visibleRestoreName.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var titleLab: UILabel = {
        ...
        lab.textColor = UIColor.elementColor()
        //: lab.font = UIFont.magnitudeimateBy(type: .Semibold, fontSize: 22)
        lab.font = UIFont.magnitudeimateBy(type: .Semibold, fontSize: 22)
        //: lab.text = "Tips".localized
        lab.text = (String(str_leadingData)).localized
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var textLab1: UILabel = {
        ...
        lab.text = String(bytes: str_imageRequestData.map{thinkOfRemove(awake: $0)}, encoding: .utf8)!.localized
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var textLab2: UILabel = {
        ...
        lab.textColor = UIColor(hex: (str_tapName.capitalized))
        //: lab.font = UIFont.magnitudeimateBy(type: .Regular, fontSize: 16)
        lab.font = UIFont.magnitudeimateBy(type: .Regular, fontSize: 16)
        //: lab.numberOfLines = 0
        lab.numberOfLines = 0
        //: lab.text = "1. Hate comments or rumors. \n2. Induce others to send gifts. \n3. Induce others to pay and trade on money. \n4. Nudity or sexual activity. \n5. Advertising information. \n6. Other contents prohibited by laws and administrative regulations.".localized
        lab.text = String(bytes: str_blockName.reversed(), encoding: .utf8)!.localized
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var okBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.gradientShared(colors: UIColor.endColor(), size: CGSize(width: 255, height: 50)), for: .normal)
...
extension PetNameTipsView {
    //: func showView(okHandler: @escaping () -> Void) {
    func query(okHandler: @escaping () -> Void) {
        //: show()
        showExecute()
        // bind event
        ...
        okBtn.rx.controlEvent(.touchUpInside)
            ...
            .subscribe(onNext: { [weak self] in
                ...
                kLet_guideScaleData.set(true, forKey: kLet_limitTitle)
                //: self.dismiss()
                self.capacity()
                //: okHandler()
                okHandler()
...
extension PetNameTipsView {
    ...
    private func dataBy() {
        ...
        backgroundColor = UIColor.buttonEnd(0, 0, 0, 0.6)
        //: alpha = 0
        alpha = 0
        //: addSubview(whiteBgV)
        addSubview(whiteBgV)
