...
class DisappearCallTool: NSObject {
...
extension DisappearCallTool {
    ...
    func allCamera(_ frontCamera: Bool) {
        ...
        self.ditheredColour(front: frontCamera)
    }
    
    /// 摄像头开启与关闭
    /// - Parameter openCamera: 是否开启
    //: func useCamera(_ openCamera: Bool) {
    func simulation(_ openCamera: Bool) {
        ...
        self.strikeOut(isOpen: openCamera)
    }
    ...
    func backRandom() {
        ...
        DispatchQueue.main.async {
            ...
            self.startAll(smallWindow: self.infoModel?.renderPostion != .selfOnBg)
...
extension DisappearCallTool {
    ...
    private func ditheredColour(front: Bool) {
    ...
    private func strikeOut(isOpen: Bool) {
        //: guard SenseTime_Use == true else {
        guard kLet_clickContent == true else {
            //: if isOpen {
            if isOpen {
...
extension DisappearCallTool {
    ...
    func blunt() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(inheritanceMax(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(hideViewBusy(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(dataAdd(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(audioUponNotif(notif:)),
    ...
    @objc private func inheritanceMax(notif: Notification?) {
        //: if notif == nil {
        if notif == nil {
            // 静音
    ...
    @objc private func hideViewBusy(notif: Notification?) {
        //: if notif == nil { 
    ...
    @objc private func dataAdd(notif: Notification) {
    ...
    @objc func audioUponNotif(notif: Notification) {
...
extension DisappearCallTool {
    ...
    func startAll(smallWindow: Bool) {
        //: guard SenseTime_Use == true else {
        guard kLet_clickContent == true else {
