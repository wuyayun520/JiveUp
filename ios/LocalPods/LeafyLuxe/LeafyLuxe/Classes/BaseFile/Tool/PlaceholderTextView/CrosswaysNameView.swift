...
/*: / :*/
fileprivate let str_needMmTitle:String = "all"
...
class CrosswaysNameView: UIView {
    // MARK: - 懒加载属性
    ...
    convenience init(placeholder: String?, placeholderColor: UIColor?, frame: CGRect) {
        ...
        noneColor(placeholder: placeholder, placeholderColor: placeholderColor)
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        noneColor(placeholder: nil, placeholderColor: nil)
    }
}
...
extension CrosswaysNameView {
    /// placeholder Label Setup
    //: private func setup(placeholder: String?, placeholderColor: UIColor?) {
    private func noneColor(placeholder: String?, placeholderColor: UIColor?) {
        ...
        plaleLabel.snp.remakeConstraints { make in
            ...
            make.leading.equalTo(ModelLabelOrigin().x)
            //: make.top.equalTo(PlaceholderLabelOrigin().y)
            make.top.equalTo(ModelLabelOrigin().y)
            //: make.trailing.equalTo(-PlaceholderLabelOrigin().x)
            make.trailing.equalTo(-ModelLabelOrigin().x)
        }
        ...
        placeholdertextView.textContainerInset = UIEdgeInsets(top: AddContainerInset().top, left: AddContainerInset().left, bottom: AddContainerInset().bottom, right: AddContainerInset().right)
...
extension CrosswaysNameView: UITextViewDelegate {
