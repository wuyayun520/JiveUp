...
public class ConstraintSafeArray<Element> {
...
public extension ConstraintSafeArray {
    //: var first: Element? {
    var first: Element? {
        //: var result: Element?
        var result: Element?
...
public extension ConstraintSafeArray {
    ...
    func filter(isIncluded: @escaping (Element)->Bool) ->ConstraintSafeArray<Element> {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
        ...
        return ConstraintSafeArray(array: result)
    }
    ...
    func sorted(by areInIncreasingOrder: (Element, Element)->Bool)->ConstraintSafeArray<Element> {
        //: pthread_rwlock_rdlock(&lock)
        pthread_rwlock_rdlock(&lock)
        //: let result = array.sorted(by: areInIncreasingOrder)
        let result = array.sorted(by: areInIncreasingOrder)
        //: let newArray = ThreadSafeArray<Element>(array: result)
        let newArray = ConstraintSafeArray<Element>(array: result)
        //: pthread_rwlock_unlock(&lock)
        pthread_rwlock_unlock(&lock)
        //: return newArray
        return newArray
...
public extension ConstraintSafeArray where Element: Equatable {
...
public extension ConstraintSafeArray {
    ...
    static func +=(left: inout ConstraintSafeArray, right: Element) {
        //: left.append(right)
        left.append(right)
    }
