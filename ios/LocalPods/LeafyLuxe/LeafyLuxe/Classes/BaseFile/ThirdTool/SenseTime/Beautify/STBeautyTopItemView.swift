...
class STBeautyTopItemView: UIView {
    ...
    private lazy var resetBtn: UIButton = {
        let btn = UIButton()
        btn.setImage(UIImage.nameTitle(name: "icon_cz_nor"), for: .normal)
...
extension STBeautyTopItemView {
    ...
    func setupSubviews() {
        ...
        for (i, item) in items.enumerated() {
            ...
            if i == 0 {
                ...
                let startX = PropertyLineThen.shared.direction == .rightToLeft ? (Int(kLet_failureName)-6-buttonW/2):6+buttonW/2
        ...
        resetBtn.snp.makeConstraints { make in
            make.leading.equalTo(kLet_failureName-10-30)
            make.top.equalTo(10)
    ...
    func setButtonStatus(sender: UIButton) {
        ...
        self.selectButton.titleLabel?.font = UIFont.magnitudeimateBy(type: .Semibold, fontSize: 14)
    ...
    @objc func resetBtnClick() {
        ...
        TalkingCostExhibitThen.directionUse(message: "Restore to default Beautify Settings".localized, leftBtnTitle: "Cancel".localized, rightBtnTitle: "OK".localized, leftBlock: {
