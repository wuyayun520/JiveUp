...
@objcMembers public class STParamUtil: NSObject {
    ...
    func getFilterModelPathsByType(type: STEffectsType) -> Array<Any> {
        ...
        let strBundlePath: String = NothingsPodspecBundle.bundle.resourcePath?.appending(strPrefix.appending(".bundle")) ?? ""
    ...
    func getTrackerPaths() -> Array<Any> {
        ...
        let strBundlePath: String = NothingsPodspecBundle.bundle.resourcePath ?? ""
