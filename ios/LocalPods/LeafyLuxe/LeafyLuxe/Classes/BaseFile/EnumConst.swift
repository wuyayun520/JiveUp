...
enum SerrationDoingsetTarget: Int {
    //: case Social  = 0
    case Social = 0 // 交友
    //: case Moment  = 1
    case Moment = 1 // 动态
...
enum ImageTableConvertible: String {
    //: case AppleLogin
...
/// 性别
//: enum Gender: String {
enum CheckedUTF8Initializable: String {
    //: case unknown = "0"
    case unknown = "0"
    //: case male    = "1"
    case male = "1"
...
@objc enum MakePropertyProtocol: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum SessionBorderSignedTotal: Int {
    //: case Unavailable = 0
...
enum PurviewCellType: CaseIterable {
...
enum LabelAdditiveArithmetic: Int {
    //: case nor = 1
    case nor = 1
    //: case match = 2
    case match = 2
