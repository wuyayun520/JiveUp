...
/*: "id" :*/
fileprivate let str_toNumberimateValue:[Character] = ["i","d"]
...
struct HeadTransformable: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: SessionManagerMomentModel?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [DiningRoomAttendantMeasurable]? // 相册
    ...
    var aiExtraInfo = LabelModelType() // AI模型
    //: var vipSkinId = 0
...
struct SessionManagerMomentModel: HandyJSON {
    //: var count: Int = 0
    var count: Int = 0
    //: var list: Array<TalkingUserInfoMomentItemModel>?
    var list: [MinTransformable]?
}

// MARK: - 动态Item

//: struct TalkingUserInfoMomentItemModel: HandyJSON {
struct MinTransformable: HandyJSON {
...
struct DiningRoomAttendantMeasurable: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func cellAfter(compareTo: DiningRoomAttendantMeasurable) -> Bool {
        //: return
        return
...
enum NameSessionTransformable: Int {
    //: case Normal    = 0
    case Normal = 0 // 正常
    //: case Reviewing = 1
