...
fileprivate let str_leadingText:[UInt8] = [0x80,0x85,0x80,0x8b,0x3f,0x7a,0x86,0x7b,0x7c,0x89,0x51,0x40,0x37,0x7f,0x78,0x8a,0x37,0x85,0x86,0x8b,0x37,0x79,0x7c,0x7c,0x85,0x37,0x80,0x84,0x87,0x83,0x7c,0x84,0x7c,0x85,0x8b,0x7c,0x7b]

fileprivate func rowView(title num: UInt8) -> UInt8 {
...
/*: "TitleReusableView" :*/
fileprivate let str_controlValue:String = "true error signal modelTalki"
...
typealias DeleteTagBlock = (CostTagModel) -> Void

//: class TalkingTagView: UIView {
class TaskViewDelegate: UIView {
    //: var deleteBlock: DeleteTagBlock!
    var deleteBlock: DeleteTagBlock!
    //: var titles = [UserSeleteTagModel]()
    var titles = [CostTagModel]()
    //: var tagContentAlignment = TagContentAlignment.left {
    var tagContentAlignment = HairTextAlignment.left {
        //: didSet {
        didSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_leadingText.map{rowView(title: $0)}, encoding: .utf8)!)
    }
...
extension TaskViewDelegate: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: (String(str_controlValue.suffix(5)) + "ngTagCell"), for: indexPath) as! TitleReusableView
...
extension TaskViewDelegate: EqualLayoutDelegate {
    ...
    func gift(_: RowTagLayout, collectionView _: UICollectionView, sizeForSupplementaryElementOfKind _: String, at _: Int) -> CGSize {
...
extension TaskViewDelegate {
    ...
    func misnomer(frame _: CGRect) {
        //: collectionView.frame = self.bounds
        collectionView.frame = self.bounds
        //: collectionView.backgroundColor = .white
        collectionView.backgroundColor = .white
        //: collectionView.register(TalkingTagCell.self, forCellWithReuseIdentifier: "TalkingTagCell")
        collectionView.register(TitleReusableView.self, forCellWithReuseIdentifier: (String(str_controlValue.suffix(5)) + "ngTagCell"))
