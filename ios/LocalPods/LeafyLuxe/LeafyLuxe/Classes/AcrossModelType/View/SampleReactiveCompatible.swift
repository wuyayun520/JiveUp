...
fileprivate let str_resultViewTitle:[UInt8] = [0xee,0xe9,0xee,0xf3,0xaf,0xe4,0xe8,0xe3,0xe2,0xf5,0xbd,0xae,0xa7,0xef,0xe6,0xf4,0xa7,0xe9,0xe8,0xf3,0xa7,0xe5,0xe2,0xe2,0xe9,0xa7,0xee,0xea,0xf7,0xeb,0xe2,0xea,0xe2,0xe9,0xf3,0xe2,0xe3]

private func addVoice(table num: UInt8) -> UInt8 {
    return num ^ 135
}

/*: "Add" :*/
fileprivate let str_publishValue:[Character] = ["A","d","d"]

/*: "btn_me_edit" :*/
fileprivate let str_leadingData:String = "btn_info index social"

/*: "Program" :*/
fileprivate let str_fromRestoreTitle:[Character] = ["P","r","o","g","r","a","m"]
...
class SampleReactiveCompatible: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_resultViewTitle.map{addVoice(table: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var backBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(priceData), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var tipsLab: UILabel = {
        ...
        lb.text = (String(str_publishValue)).localized
        //: return lb
        return lb
        //: }()
    }()
    ...
    private lazy var editImg: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.nameTitle(name: (String(str_leadingData.prefix(4)) + "me_edit")))
        //: imag.isUserInteractionEnabled = false
        imag.isUserInteractionEnabled = false
        //: return imag
        return imag
...
extension SampleReactiveCompatible {
    ...
    func age(title: String, icon: String) {
        //: iconImg.image = UIImage.nameTitle(name: icon)
        iconImg.image = UIImage.nameTitle(name: icon)
        //: titleLab.text = title.localized
        titleLab.text = title.localized
        //: if title == "Program" {
        if title == (String(str_fromRestoreTitle)) {
    ...
    func addTargetHidden(isHidden: Bool) {
    ...
    func setTo() {
        ...
        backBtn.showRadii(width: kLet_failureName - 30, height: 50, corners: [.topLeft, .topRight], cornerRadii: .init(width: 8, height: 8))
    }
}
