...
/*: "detection" :*/
fileprivate let str_locationValue:[Character] = ["d","e","t","e","c","t","i","o","n"]

/*: "aiff" :*/
fileprivate let str_statusIndicatorValue:[Character] = ["a","i","f","f"]
...
class ArrayReactiveCompatible: NSObject {
    // singleton
    //: static let shared = RBDMuteSwitch()
    static let shared = ArrayReactiveCompatible()
    ...
    func superiorQuery() {
        ...
        let soundFilePath = PuncherEffectTool.default.befitType(name: (String(str_locationValue)), type: (String(str_statusIndicatorValue)))
        ...
        let soundCompletionCallback: AudioServicesSystemSoundCompletionProc = { soundID, _ in
            ...
            ArrayReactiveCompatible.shared.award()
        }
    ...
    @objc private func totalervalShow() {
        //: soundDuration += 0.001
        soundDuration += 0.001
    }
