...
/*: "&sr=6" :*/
fileprivate let str_imagePathScaleData:[Character] = ["&","s","r","=","6"]
...
enum ViewNameMagnitudeerpolation: String, CaseIterable {
...
enum OpticText: String {
    ...
    case GiftBroadcast = "/dist/homepage/setAnnouncement.html" // 礼物广播
    //: case RechargeFullPage   = "/dist/recharge/index.html?isfull=true"                                   // 全屏充值
    case RechargeFullPage = "/dist/recharge/index.html?isfull=true" // 全屏充值
    //: case RechargeHalfPage   = "/dist/recharge/index.html?isfull=false"                                  // 半屏充值
    case RechargeHalfPage = "/dist/recharge/index.html?isfull=false" // 半屏充值
    //: case RechargeAlert      = "/dist/recharge/index5.html?transparency=1"                               // 充值弹窗
    case RechargeAlert = "/dist/recharge/index5.html?transparency=1" // 充值弹窗
    ...
    case SubscribePage = "/dist/loungePlus/index.html?type=4&hideStatusBar=1&transparency=1" // 会员订阅页面
    //: case SubscribeAlert     = "/dist/loungePlus/index5.html?hideStatusBar=1&transparency=1"             // 会员订阅弹窗
    case SubscribeAlert = "/dist/loungePlus/index5.html?hideStatusBar=1&transparency=1" // 会员订阅弹窗
...
class SizeManager: NSObject {
    ...
    class func magnitudeeractionAdd(urlType: OpticText) -> String {
        //: var url = SubLabelReactiveCompatible.share.appConfigMode.urlH5Domain
        var url = SubLabelReactiveCompatible.share.appConfigMode.urlH5Domain
        //: switch urlType {
        switch urlType {
        //: case .RechargeFullPage:
        case .RechargeFullPage:
            //: url.append(SubLabelReactiveCompatible.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : SubLabelReactiveCompatible.share.appUserConfigMode.fullRechargePage)
            url.append(SubLabelReactiveCompatible.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : SubLabelReactiveCompatible.share.appUserConfigMode.fullRechargePage)

        //: break
        //: case .RechargeHalfPage:
        case .RechargeHalfPage:
            //: url.append(SubLabelReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : SubLabelReactiveCompatible.share.appUserConfigMode.halfRechargePage)
            url.append(SubLabelReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : SubLabelReactiveCompatible.share.appUserConfigMode.halfRechargePage)

        //: case .RechargeToVideoInitivHalfPage:
        case .RechargeToVideoInitivHalfPage:
            //: let newstr = SubLabelReactiveCompatible.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            let newstr = SubLabelReactiveCompatible.share.appUserConfigMode.halfRechargePage.appending((String(str_imagePathScaleData)))
            //: url.append(SubLabelReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
            url.append(SubLabelReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
        //: default:
        default:
