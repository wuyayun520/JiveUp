...
/*: "App" :*/
fileprivate let str_managerData:String = "group screen list button playerApp"

/*: "blockList_ :*/
fileprivate let str_pageName:String = "hiddenl"
fileprivate let str_subData:String = "ockList_status where if"
...
class SessionThen: NSObject {
    ...
    func inWithEndUser(userId: String) -> Bool {
    ...
    private func pullInAddTo() -> String {
        //: let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        //: let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent("App")
        let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent((String(str_managerData.suffix(3))))
        ...
        let filePath = (appDirectoryPath as NSString).appendingPathComponent((str_pageName.replacingOccurrences(of: "hidden", with: "b") + String(str_subData.prefix(8))) + "\(uid)")
        //: return filePath
        return filePath
    }
}
