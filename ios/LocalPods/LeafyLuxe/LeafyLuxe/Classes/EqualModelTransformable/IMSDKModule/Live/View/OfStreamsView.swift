...
fileprivate let str_seatData:[UInt8] = [0x43,0x44,0x43,0x5e,0x2,0x49,0x45,0x4e,0x4f,0x58,0x10,0x3,0xa,0x42,0x4b,0x59,0xa,0x44,0x45,0x5e,0xa,0x48,0x4f,0x4f,0x44,0xa,0x43,0x47,0x5a,0x46,0x4f,0x47,0x4f,0x44,0x5e,0x4f,0x4e]

private func upStack(at num: UInt8) -> UInt8 {
    return num ^ 42
}
...
class OfStreamsView: AtOfThen {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_seatData.map{upStack(at: $0)}, encoding: .utf8)!)
    }
...
extension OfStreamsView {
    /// 开始播放直播
    //: func setupPlayer(liveUrl: String) {
    func immediate(liveUrl: String) {
...
extension OfStreamsView: TXLivePlayListener {
