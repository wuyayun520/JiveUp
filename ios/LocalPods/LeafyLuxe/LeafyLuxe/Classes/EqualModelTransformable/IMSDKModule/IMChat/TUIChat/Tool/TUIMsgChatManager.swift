...
//
//        let userDic = ["uid":SubLabelReactiveCompatible.share.loginUserMode.userID,"nickName":SubLabelReactiveCompatible.share.loginUserMode.nickname,"headPic":SubLabelReactiveCompatible.share.loginUserMode.headPic,"mbId":msgInfo["mbId"]]
...
//
//        if msgTypeStr == "gift" {
//            let cellData = AbServerCellData.init(direction: (isSend ? TMsgDirection.MsgDirectionOutgoing : TMsgDirection.MsgDirectionIncoming))
//            let data = extraString.data(using: .utf8)
//            cellData.innerMessage = V2TIMManager.sharedInstance().createCustomMessage(data)
//            do {
//                let msgModel = try TitleBlendModel.init(dictionary: tempDic)
...
//
//            let cellData = MagnitudeernationalismReactiveCompatible.init(direction: (isSend ? TMsgDirection.MsgDirectionOutgoing : TMsgDirection.MsgDirectionIncoming))
//            let data = extraString.data(using: .utf8)
//            cellData.innerMessage = V2TIMManager.sharedInstance().createCustomMessage(data)
//            do {
//                let msgModel = try TitleBlendModel.init(dictionary: tempDic)
...
//            let cellData = ShareThen.init(direction: (isSend ? TMsgDirection.MsgDirectionOutgoing : TMsgDirection.MsgDirectionIncoming))
//            let data = extraString.data(using: .utf8)
//            cellData.innerMessage = V2TIMManager.sharedInstance().createCustomMessage(data)
//            do {
//                let msgModel = try TitleBlendModel.init(dictionary: tempDic)
...
//            let cellData = TempRoomCellData.init(direction: (isSend ? TMsgDirection.MsgDirectionOutgoing : TMsgDirection.MsgDirectionIncoming))
//            let data = extraString.data(using: .utf8)
//            cellData.innerMessage = V2TIMManager.sharedInstance().createCustomMessage(data)
//            do {
//                let msgModel = try TitleBlendModel.init(dictionary: tempDic)
