...
@objcMembers public class TalkingSystemMsgCellData: TUIMessageCellData {
    ...
    var contentFont = UIFont.rugularSize(fontSize: 13)
    var contentColor = UIColor.videoValue()
    ...
    public override func contentSize() -> CGSize {
        let textSize = CGSize(width: kLet_failureName/2, height: kLet_appEventDomainName)
