...
fileprivate let str_successValue:[UInt8] = [0x60,0x67,0x60,0x7d,0x21,0x6a,0x66,0x6d,0x6c,0x7b,0x33,0x20,0x29,0x61,0x68,0x7a,0x29,0x67,0x66,0x7d,0x29,0x6b,0x6c,0x6c,0x67,0x29,0x60,0x64,0x79,0x65,0x6c,0x64,0x6c,0x67,0x7d,0x6c,0x6d]

private func buttonBlind(with num: UInt8) -> UInt8 {
    return num ^ 9
}
...
class HadithShieldView: UIView {
    //: class func create(_ frame: CGRect) -> UIView {
    class func resource(_ frame: CGRect) -> UIView {
        //: return MAScreenShieldView(frame: frame)
        return HadithShieldView(frame: frame)
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_successValue.map{buttonBlind(with: $0)}, encoding: .utf8)!)
    }
