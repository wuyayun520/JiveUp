...
/*: _" :*/
fileprivate let str_actualTitle:String = "component"

/*: ".png" :*/
fileprivate let str_loadText:String = ".pngroom gift frame"
...
//: @objcMembers public class ShareThen: TalkingChatMsgBaseCellData {
@objcMembers public class ShareThen: BorderCellData {
    ...
    override public var msgModel: TitleBlendModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.subData(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func addImage(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(kLet_countContent)
        ...
        let interval = Date().timeIntervalSince1970 * 1000
        //: let imageName = "\(Int(interval))_" + SubLabelReactiveCompatible.share.loginUserMode.userID + ".png"
        let imageName = "\(Int(interval))_" + SubLabelReactiveCompatible.share.loginUserMode.userID + (String(str_loadText.prefix(4)))
        ...
        let imageData = UIImage.largeObject(image, lengthIdentity: 2 * 1024)
