...
fileprivate let str_makeLiveData:[UInt8] = [0x7e,0x79,0x7e,0x63,0x3f,0x74,0x78,0x73,0x72,0x65,0x2d,0x3e,0x37,0x7f,0x76,0x64,0x37,0x79,0x78,0x63,0x37,0x75,0x72,0x72,0x79,0x37,0x7e,0x7a,0x67,0x7b,0x72,0x7a,0x72,0x79,0x63,0x72,0x73]

/*: "icon_livetc_warn" :*/
fileprivate let str_transformValue:String = "number for viewicon_l"
fileprivate let str_crushData:String = "title path succeed_warn"

/*: "OK" :*/
fileprivate let str_appValue:String = "wayK"
...
class RemoveDismissView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_makeLiveData.map{$0^23}, encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        let iamg = UIImageView()
        //: iamg.image = UIImage.nameTitle(name: "icon_livetc_warn")
        iamg.image = UIImage.nameTitle(name: (String(str_transformValue.suffix(6)) + "ivetc" + String(str_crushData.suffix(5))))
    ...
    private lazy var contentLab: UILabel = {
        ...
        lab.textAlignment = .center
        //: lab.text = SubLabelReactiveCompatible.share.appUserConfigMode.blockCameraPopupContent
        lab.text = SubLabelReactiveCompatible.share.appUserConfigMode.blockCameraPopupContent
        //: lab.numberOfLines = 0
        lab.numberOfLines = 0
        //: return lab
    ...
    private lazy var closeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(coinMakeClick), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension RemoveDismissView {
    ...
    @objc private func coinMakeClick() {
        //: dismiss()
        modeApp()
    }
}
