...
let kLet_likeUserValue = actualWidth(w: 275)
//: let VideoMsgTableViewHeight =  actualWidth(w: 200)
let kLet_turnValue = actualWidth(w: 200)
//: let VideocellLineSpeing = 3
let kLet_timeChangeName = 3 /// cell间距

//: struct TalkingVideoCallDanmuModel: HandyJSON {
struct RoomTransformable: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var senderUid = ""
    var senderUid = ""
